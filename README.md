...
‘Pizza_Sales_Dashboard.pbix’:  [Download the Pizza Sales Dashboard](reports/Pizza_Sales_dashboard.pbix) Power BI file containing details on EDA, data transformations, and visualizations.
...
‘Pizza_Sales_Dashboard.pdf’: [Download the Dashboard Preview in pdf](reports/Pizza_Sales_Dashboard.pdf) Pdf file of dashboard for viewing final output.
